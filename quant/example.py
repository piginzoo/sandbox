...
DataAPI.MktStockFactorsDateRangeGet(secID=u"", ticker=u"000001", beginDate=u"20170612", endDate=u"20170616", field=u"",
                                    pandas="1")
...
# print(CLVfactorstack.head(2))
# print(forward_5d_return_datastack.head(2))
