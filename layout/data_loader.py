...
def load_data(path):
    ...
    # image_names= ["国寿祥瑞终身寿险.jpg"]
    # image_names= ["鑫盛12（996）.jpg"]
    # image_names= ["百万守护重大疾病保险.jpg"]
    # image_names= ["鑫利（936）.jpg"]
    # image_names= ["信泰爱驾宝两全保险.jpg"]
    # image_names= ["工银安盛人寿御立方三号两全保险.jpg"]
    # image_names= ["百万任我行（1149）.jpg"]
    images = []
    all_pos = []
    all_txt = []
    all_bboxes = []
